...
class HospitalLocationsListingAdapter(private var  hospitalList: ArrayList<Locations>,
                                      private val interaction: Interaction? = null) :
    RecyclerView.Adapter<RecyclerView.ViewHolder>(), Filterable {

    var hospitalFilterList = ArrayList<Locations>()

    val DIFF_CALLBACK = object : DiffUtil.ItemCallback<Locations>() {
    ...
    fun submitList(list: List<Locations>) {
    ...
    class ShoppingItemVH constructor(
        ...
        fun bind(item: Locations, pos : Int) {
...
*/
            mBinder.root.setOnClickListener(View.OnClickListener {
                interaction?.onLocationSelected(pos, item, mBinder.root)
            })
    ...
    interface Interaction {
        fun onLocationSelected(position: Int, item: Locations, view : View)
    }
        ...
        return object : Filter() {
            override fun performFiltering(constraint: CharSequence?): FilterResults {
                ...
                if (charSearch.isEmpty()) {
                    ...
                    val resultList = ArrayList<Locations>()
            ...
            override fun publishResults(constraint: CharSequence?, results: FilterResults?) {
                hospitalFilterList = results?.values as ArrayList<Locations>
