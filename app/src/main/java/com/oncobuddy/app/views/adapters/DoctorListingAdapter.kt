...
import com.oncobuddy.app.databinding.RawDoctorBinding
import com.oncobuddy.app.models.pojo.doctors.doctors_listing.Doctor
import java.util.*
import kotlin.collections.ArrayList


class DoctorListingAdapter(private var doctorList : ArrayList<Doctor>,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val mBinder: RawDoctorBinding
        mBinder = DataBindingUtil.inflate(
            LayoutInflater
                .from(parent.context), R.layout.raw_doctor, parent, false
        )
