...
import com.oncobuddy.app.databinding.ItemSpecialistDetailsBinding
import com.oncobuddy.app.databinding.RawHelpVideosBinding
import com.oncobuddy.app.models.pojo.YoutubeVideo


class VerticalAlliedDoctorsAdapter(private var youtubeVideosList: ArrayList<YoutubeVideo>,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val mBinder: ItemSpecialistDetailsBinding
        mBinder = DataBindingUtil.inflate(
            LayoutInflater
                .from(parent.context), R.layout.item_specialist_details, parent, false
        )
    ...
    class ShoppingItemVH constructor(
        binding: ItemSpecialistDetailsBinding,
        private val interaction: Interaction?
    ) : RecyclerView.ViewHolder(binding.root) {
        var mBinder: ItemSpecialistDetailsBinding = binding

        fun bind(item: YoutubeVideo, pos : Int) {
            mBinder.root.setOnClickListener(View.OnClickListener {
                interaction?.onDoctorSelected(pos, item, mBinder.root)
            })
        /*   mBinder.root.setOnClickListener(View.OnClickListener {
    ...
    interface Interaction {
        fun onDoctorSelected(position: Int, item: YoutubeVideo, view : View)
    }
