...
class CancerTypeListingAdapter(private var  cancerTypeList: ArrayList<CancerType>,
...
*/
            mBinder.root.setOnClickListener(View.OnClickListener {
                interaction?.onCancerTypeSelected(pos, item, mBinder.root)
            })
    ...
    interface Interaction {
        fun onCancerTypeSelected(position: Int, item: CancerType, view : View)
    }
