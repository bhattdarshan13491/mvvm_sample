...
class PastAppointmentsNewAdapter(private var appointmentsList : ArrayList<AppointmentDetails>,
...
*/              mBinder.ivDropDown.visibility = View.VISIBLE
            ...
            mBinder.ivMenu.setOnClickListener(View.OnClickListener {
                interaction?.onPastItemSelected(pos, item, mBinder.ivMenu)
            })
            mBinder.cardContainer.setOnClickListener(View.OnClickListener {
                interaction?.onPastItemSelected(pos, item, mBinder.cardContainer)
            })
        }
    ...
    interface Interaction {
        fun onPastItemSelected(position: Int, item: AppointmentDetails, view : View)
    }
