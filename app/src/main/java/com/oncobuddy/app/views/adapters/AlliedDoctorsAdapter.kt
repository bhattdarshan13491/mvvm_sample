...
class AlliedDoctorsAdapter(private var youtubeVideosList: ArrayList<YoutubeVideo>,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val mBinder: ItemSpecialistCardBinding
        mBinder = DataBindingUtil.inflate(
            LayoutInflater
                .from(parent.context), R.layout.item_specialist_card, parent, false
        )
    ...
    class ShoppingItemVH constructor(
        binding: ItemSpecialistCardBinding,
        private val interaction: Interaction?
    ) : RecyclerView.ViewHolder(binding.root) {
        var mBinder: ItemSpecialistCardBinding = binding
    ...
    interface Interaction {
        fun onSpecialistSelected(position: Int, item: YoutubeVideo, view : View)
    }
